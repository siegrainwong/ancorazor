...
namespace Blog.EF.Entity.Migrations
{
    ...
    [Migration("20190505131716_Initial")]
            ...
            modelBuilder.Entity("Blog.EF.Entity.Users", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AuthUpdatedAt = new DateTime(2019, 5, 5, 21, 17, 16, 2, DateTimeKind.Local).AddTicks(1179),
                            CreatedAt = new DateTime(2019, 5, 5, 21, 17, 16, 1, DateTimeKind.Local).AddTicks(9677),
                            IsDeleted = false,
                            LoginName = "admin",
                            Password = "$SGHASH$V1$10000$RA3Eaw5yszeel1ARIe7iFp2AGWWLd80dAMwr+V4mRcAimv8u",
                            RealName = "Admin",
                            Status = 1,
                            UpdatedAt = new DateTime(2019, 5, 5, 21, 17, 16, 2, DateTimeKind.Local).AddTicks(622)
                        });
                });
